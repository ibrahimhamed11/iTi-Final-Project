...
var date = require('date-and-time'); // Configure multer for file storage
...
exports.getAllUsers = function _callee8(req, res) {
  var users;
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 7:
          ...
          console.error('Error retrieving users:', _context8.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getAllMothers = function _callee9(req, res) {
  var mothers;
    ...
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 7:
          ...
          console.error('Error retrieving mothers:', _context9.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getAllPregnants = function _callee10(req, res) {
  var pregnants;
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 7:
          ...
          console.error('Error retrieving pregnants:', _context10.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getAllAdmins = function _callee11(req, res) {
  var admins;
    ...
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 7:
          ...
          console.error('Error retrieving Admins:', _context11.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getAllSeller = function _callee12(req, res) {
  var sellers;
    ...
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 7:
          ...
          console.error('Error retrieving sellers:', _context12.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getAllpregnant = function _callee13(req, res) {
  var pregnants;
    ...
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 7:
          ...
          console.error('Error retrieving pregnants:', _context13.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getNumberOfPregnant = function _callee14(req, res) {
    ...
    while (1) {
      switch (_context14.prev = _context14.next) {
        ...
        case 8:
          ...
          console.error('Error retrieving pregnants:', _context14.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getNumberOfMothers = function _callee15(req, res) {
    ...
    while (1) {
      switch (_context15.prev = _context15.next) {
        ...
        case 8:
          ...
          console.error('Error retrieving number of mothers:', _context15.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getNumberOfSellers = function _callee16(req, res) {
    ...
    while (1) {
      switch (_context16.prev = _context16.next) {
        ...
        case 8:
          ...
          console.error('Error retrieving number of sellers:', _context16.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getNumberOfUsers = function _callee17(req, res) {
  var users, count;
    ...
    while (1) {
      switch (_context17.prev = _context17.next) {
        ...
        case 8:
          ...
          console.error('Error retrieving users:', _context17.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
...
exports.getMotherRegisteredPerDay = function _callee18(req, res) {
...
exports.getPregnantRegisteredPerDay = function _callee19(req, res) {
  var registrations, result;
...
exports.getSellerRegisteredPerDay = function _callee20(req, res) {
  var registrations, result;
